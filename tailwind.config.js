// Default color palette is black when no themes are loaded (dark-theme fallbacks)
...
module.exports = {
  ...
  theme: {
    backgroundColor: { ...backgroundColors, ...controlsBgColors },
    borderColor: borderColors,
    stroke: borderColors,
    divideColor: borderColors,
    placeholderColor: { primary: "var(--text-primary, #EEF1F7)" },
