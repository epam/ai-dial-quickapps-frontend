  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="w-96 rounded-lg bg-layer-2 p-6 shadow-xl">
        ...
        <div className="mb-6">
          <label className="mb-2 block text-sm font-medium">{t(MarketplaceI18nKeys.ConnectVia)}</label>
          <div className="flex flex-col gap-2">
            {supportsMcp && (
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  onChange={() => setSelectedTransport(DialAppTransportType.MCP)}
            ...
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                ...
                onChange={() => setSelectedTransport(DialAppTransportType.ChatCompletion)}
                className="accent-accent"
              />
