...
export enum MarketplaceI18nKeys {
  ...
  WebFetch = 'Web fetch',
  AllowTheAgentToFetchWebResources = 'Allow the agent to fetch web resources',
  WebFetchDescription = 'Enables the orchestrator’s built-in tool for fetching an external web resource for this app. When enabled, the agent can fetch an external URL and get its content back inline, or saved to the app’s workspace for larger content. When disabled, no fetch tool is exposed to the orchestrator.',
